...
$lang['Attach_posting_cp_explain'] = "If you click on <b>Add</b> an Attachment, you will see the box for adding Attachments.<br />If you click on <b>Posted</b> Attachments, you will see a list of files already attached and will be able to edit them.<br />If you want to <b>Replace</b> an attachment, you have to enter the file name in the Add an Attachemnt box and then click on Upload New Version in the Posted Attachments box for the attachment you intend to update.";
...
$lang['Club_upload_quota_reached'] = "Sorry, you have reached your Club Upload Quota Limit of %d %s"; // replace %d with Size, %s with Size Lang (MB for example)
