...
$faq[] = array("Who do I contact about illegal or possibly illegal attachments?", "You should contact the administrator of this board. <br />If you cannot find who this is you should first contact one of the forum moderators and ask them who you should in turn contact. <br />The e-mail address admin@... [this domain] will always be processed by a site administrator.");
